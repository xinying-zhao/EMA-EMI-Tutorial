...
![EMA研究全流程全景图](images/fig_ch00_schoevers_flow.png)
*图0-1：EMA 研究全流程：从目标队列筛选到有效数据集纳入的流程示意。引自 Schoevers et al.（2021），*Psychological Medicine*，[DOI: 10.1017/S0033291720000689](https://doi.org/10.1017/S0033291720000689)，CC BY 4.0 许可。*
...
- **阶段七：研究报告撰写与学术发表（第 7 章）**。系统梳理 EMA 报告规范体系（Stone & Shiffman 2002、CREMAS、STROBE-EMA、eMOOD、STROBE-GEMA 等），并强制要求研究者在撰写学术论文时对照相应清单进行透明化披露，以确保研究的科学价值与可重复性。（注：生态瞬时干预 EMI 的进阶内容将在后续专章中单独呈现。）
