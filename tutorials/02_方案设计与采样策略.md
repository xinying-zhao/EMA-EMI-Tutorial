...
![多重采样协议设计图](images/fig_ch02_sahandi_protocol.png)
*图2-1：研究者端 EMA 问卷与评估协议的配置界面（含条目设置、调度与分支逻辑），用于落实采样方案。引自 Sahandi Far et al.（2025），*Journal of Medical Internet Research*，[DOI: 10.2196/51689](https://doi.org/10.2196/51689)，CC BY 4.0 许可。*
