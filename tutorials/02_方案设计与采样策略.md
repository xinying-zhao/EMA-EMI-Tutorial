...
![[Figure 4.png]]
*图2-1：EMAI 研究者端问卷与评估协议的配置界面（含条目设置、调度与分支逻辑），用于落实采样方案。图片来源：EMAI 官网（[zenseven.cn](https://www.zenseven.cn)）。*
...
- Myin-Germeys, I., & Kuppens, P. (Eds.). (2021). *[The Open Handbook of Experience Sampling Methodology](https://www.kuleuven.be/samenwerking/real/real-book)* (2nd ed.). Center for Research on Experience Sampling and Ambulatory Methods Leuven (REAL), KU Leuven.
