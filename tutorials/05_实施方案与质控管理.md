...
在执行周期为几周的生态瞬时评估（EMA）项目时，不管是全民饮食追踪还是抑郁症情绪监测，研究者通常会面临一个严峻的方法学挑战：受试者的依从性（Compliance）会随时间推移出现不可逆衰减。研究前三天，受试者往往能保持高达 90% 的数据回复率，但随着新鲜感消退及日常生活干扰，漏填和随意作答（如调查疲劳引发的直线式打分）现象会明显增多。

这种衰减是 EMA 研究的普遍规律。Ono 等人（2019）对 13 个慢性疼痛 EMA 数据集、701 名患者做的个体参与者数据（IPD）元分析发现，总体完成率为 85%，但完成率随研究天数推进显著下降（P < .001）。Rintala 等人（2019）对十个 ESM 数据集的再分析也显示，依从性从首日约 78% 逐日下滑，至第 5 天降至约 73%。这种下降往往**并非随机**：Ono 等人（2019）发现年轻受试者的完成率整体更低，其随时间衰减的速度也显著快于年长者（年龄 × 研究天数的交互作用，P = .02）。

临床与社会学观察同样表明，那些抑郁症状加重、处于重度社交退缩状态，或正处于极高工作压力下的受试者往往最先放弃填答问卷。这种数据缺失属于"非随机缺失（NMAR）"，而非"完全随机缺失（MCAR）"。如果不加干预，研究者最终收集到的数据集将只反映个体状态较好、较空闲时的片段，进而在统计模型中引入严重的幸存者偏差：事后保留在数据中的样本系统地偏离了最初的目标人群。

## 5.2 依从性的实证基准与影响因素

设计质控方案前，研究者需要先了解依从性的"正常水平"及其主要影响因素，以建立合理的预期与干预阈值。
...
**影响因素**。基于上述元分析，研究者应关注以下三类因素：

- **年龄**：Ono 等人（2019）发现年轻受试者完成率更低且衰减更快，可能与其更易分心、粗心作答有关；针对老年人群的 EMA 研究则长期偏少。Kim 等人（2020）对 38 项研究的整合综述发现，老年受试者的非依从多源于技术问题、感官/认知障碍等"客观障碍"，而非意愿不足。通过合理的辅助手段可以显著改善其完成率。
...
- **经济激励**：多项元分析一致表明，提供经济激励的 EMA 研究依从性显著更高（Wrzus & Neubauer, 2023；Ono et al., 2019）。该证据为阶梯式补偿方案提供了直接的理论与实证支持。

## 5.3 质量控制与依从性管理的实操步骤

为了对抗依从性疲劳，研究团队需在项目启动之初与受试者建立稳固的"心理契约"，并设计一套涵盖前置干预、经济激励与实时监控的多维度质量控制机制。Russell 与 Gajos（2020）在其综述中指出，针对脆弱群体或高负荷人群，依赖研究结束时的一次性报酬往往缺乏持续驱动力，需引入阶梯式激励与临床关怀。

具体实施中，研究团队应执行以下步骤：

- **步骤一：标准化入组培训（Onboarding）**。研究人员与每位受试者做 15-30 分钟的面对面（或视频）沟通，亲自协助在个人智能手机上安装相应应用程序，逐一排查操作系统的通知权限（将 App 加入电池优化白名单），确保推送不被系统底层拦截。同时，指导受试者完成首次测试填答，消除初期技术阻力。该环节对老年受试者尤为重要：Kim 等人（2020）发现，技术问题与用户错误是老年人群非依从的首要原因，研究者应主动提供适应性支持，如为视觉障碍者准备更大字体的设备或放大镜、为手部灵活性受限者提供触控笔、允许受试者选择自己熟悉的操作系统，并确认设备在离线状态下仍可完成记录。
- **步骤二：部署阶梯式补偿方案（Tiered Compensation）**。摒弃一次性结算模式，将总体预算拆分为三个层级：基础参与费（保障底线）、单次成功填答的微奖励（提供即时正强化），以及针对高完成率（如总体回复率超过 80%）的满勤奖金。经济激励对依从性的提升作用已得到元分析证据支持（Wrzus & Neubauer, 2023；Ono et al., 2019），该机制利用行为心理学中的正强化原理，促使受试者在疲惫时仍愿意完成任务。
...
- **步骤四：危机预警与人工介入**。系统发出预警后（如某位受试者连续三次未能响应），研究助理需在 24 小时内，通过温和且充满关怀的话术主动介入，询问受试者是否遇到技术困难或需要支持，在流失边缘挽回数据样本。Ono 等人（2019）强调，与受试者频繁接触以保持其参与动机，往往比压缩任务负荷更关键。条件允许时，为受试者提供基于自身数据的个性化反馈报告（如图表形式的情绪周报或运动轨迹分析），可将外部任务转化为内在的自我探索动机。
...
依从性并非在所有人群中均匀分布，质控方案应针对目标人群的特征做差异化设计。
...
**社会决定因素（SDoH）差异人群**。Sun 等人（2025）对 48 项研究的范围综述显示，低收入、缺乏稳定住房、工作作息不稳定、非母语使用等社会决定因素均会系统性地影响 EMA 依从性，且其作用具有强烈的**情境依赖性**：比如失业既可能因时间充裕而提高依从性，也可能因竞争性需求而降低依从性。因此，研究者应在设计阶段预判目标人群的社会文化特征，采取语言友好、文化适配的问卷与培训，将提示时段与受试者的作息错峰，并理解在某些社会情境（如宗教仪式、正式会议）中手机使用受限的现实。
